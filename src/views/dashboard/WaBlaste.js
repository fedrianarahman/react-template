...
TOTAL TAGIHAH 40.000
  ...
  const handleKirimPesan = async () => {
    ...
    // console.log("line 183", dataPenerima);
    // console.log("line 184", formatPesan);
          ...
          <CForm onSubmit={handleSubmit} id='wa-blaste-form'>
            <CRow>
              ...
              <CCol md={3}>
                ...
                {/* <CButton style={{ marginTop: "30px", marginLeft: "10px", background: "#F6F54D", color: "#000", border: "none" }} onClick={ambilDataCheked}>cek datachecked</CButton> */}
